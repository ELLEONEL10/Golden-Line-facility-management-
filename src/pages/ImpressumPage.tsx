  ...
  return (
    <main className="legal-page">
      <div className="legal-inner">
        ...
        <p>Geschäftsführer: Kasem Alzuabi, Mohamad Al Nahhas</p>
        ...
        <h2>Geschäftsform</h2>
        <p>Die Golden Line Facility Management GmbH ist eine Gesellschaft mit beschränkter Haftung (GmbH) und Teil der GlamPotsdam Gruppe.</p>
